...
public class EmpVO {
	...
	@Size(max = 10, message = "데이터 베이스 제약조건 위해(20byte)")
	private String firstName;
	
	@Pattern(regexp = "[\\w가-힣]+", message = "성 입력")
	@Size(max = 10, message = "데이터 베이스 제약조건 위해(25byte)")
	...
	@Digits(integer = 6, fraction = 2, message = "잘못된 금액입니다. (6자리 이상 불가)")
	...
	private byte[] empPic; //blob : binary large object
